...
import { APP_BASE_URL, WEBUI_API_BASE_URL, WEBUI_BASE_URL } from '$lib/constants';
		...
		if (logo) {
			...
			if (isDarkMode) {
				const darkImage = new Image();
                            darkImage.src = `${APP_BASE_URL}/static/favicon-dark.png`;

				darkImage.onload = () => {
                                    logo.src = `${APP_BASE_URL}/static/favicon-dark.png`;
								...
								<div class="flex justify-center mb-6">
									<img
										...
										crossorigin="anonymous"
                                                                            src="{APP_BASE_URL}/static/favicon.png"
