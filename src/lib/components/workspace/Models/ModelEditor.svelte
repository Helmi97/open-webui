...
import { APP_BASE_URL, WEBUI_BASE_URL } from '$lib/constants';
	...
	let info = {
		...
		name: '',
		meta: {
                    profile_image_url: `${APP_BASE_URL}/static/favicon.png`,
			description: '',
					...
					<div class="self-center">
						...
						<div class="flex w-full mt-1 justify-end">
							<button
								...
								on:click={() => {
                                                                    info.meta.profile_image_url = `${APP_BASE_URL}/static/favicon.png`;
								}}
								type="button"
							>
